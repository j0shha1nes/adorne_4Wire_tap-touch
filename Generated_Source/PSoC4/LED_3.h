...
#define LED_3_DM_ALG_HIZ         (0x00u)
#define LED_3_DM_DIG_HIZ         (0x01u)
#define LED_3_DM_RES_UP          (0x02u)
#define LED_3_DM_RES_DWN         (0x03u)
#define LED_3_DM_OD_LO           (0x04u)
#define LED_3_DM_OD_HI           (0x05u)
#define LED_3_DM_STRONG          (0x06u)
#define LED_3_DM_RES_UPDWN       (0x07u)
