...
#define CapSense_1_TOTAL_SENSOR_COUNT            (3u)
#define CapSense_1_TOTAL_SCANSLOT_COUNT          (3u)
#define CapSense_1_INDEX_TABLE_SIZE              (0u)

/* Define Sensors */
#define CapSense_1_SENSOR_MAIN__BTN    (0u)
#define CapSense_1_SENSOR_PLUS__BTN    (1u)
#define CapSense_1_SENSOR_MINUS__BTN    (2u)
...
#define CapSense_1_PORT_PIN_CONFIG_TBL_ZISE   (3u)
...
#define CapSense_1_RESOLUTIONS_TBL_SIZE       (3u)
