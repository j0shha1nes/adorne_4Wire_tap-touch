...
reg32 * CapSense_1_pcTable[] = {
    (reg32 *)CapSense_1_Sns__MAIN__BTN__PC, 
    (reg32 *)CapSense_1_Sns__PLUS__BTN__PC, 
    (reg32 *)CapSense_1_Sns__MINUS__BTN__PC, 
};

const uint8 CapSense_1_portTable[] = {
    CapSense_1_Sns__MAIN__BTN__PORT, 
    CapSense_1_Sns__PLUS__BTN__PORT, 
    CapSense_1_Sns__MINUS__BTN__PORT, 
};

const uint32 CapSense_1_maskTable[] = {
    CapSense_1_Sns__MAIN__BTN__MASK, 
    CapSense_1_Sns__PLUS__BTN__MASK, 
    CapSense_1_Sns__MINUS__BTN__MASK, 
};

const uint8 CapSense_1_pinShiftTbl[] = {
    (uint8) CapSense_1_Sns__MAIN__BTN__SHIFT, 
    (uint8) CapSense_1_Sns__PLUS__BTN__SHIFT, 
    (uint8) CapSense_1_Sns__MINUS__BTN__SHIFT, 
};
